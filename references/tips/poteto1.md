...
·
5h
i have an automation that maintains it and keeps it up to date! i've also found that agents usually just update them along with the PR that modifies the app, because all PRs to Grok 
@Bot
 use the verification skill, the agent tends to update it while working on it. the automation
Show more
Relevant people
lauren
@poteto
...
@Bot
 at 
@SpaceXAI
. Shipping with https://cursor.com/marketplace/cursor/pstack. React compiler core team, prev 
@cursor_ai
...
Trending now
What’s happening
Just Enjoy Dokkan Battle
Global Dokkan Campaign NOW ON!
Promoted by Dragon Ball Z Dokkan Battle
Gaming · Trending
Rust
Sports · Trending
#WWERaw
