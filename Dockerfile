...
COPY OpenHands/scripts/cloudflare-models-proxy.mjs /opt/agent-canvas/cloudflare-models-proxy.mjs
...
COPY scripts/cursor-acp-bridge.mjs /opt/agent-canvas/cursor-acp-bridge.mjs
COPY scripts/cursor-stream-json-to-acp.mjs /opt/agent-canvas/cursor-stream-json-to-acp.mjs
