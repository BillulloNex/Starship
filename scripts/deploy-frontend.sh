...
export VITE_LANGFUSE_PUBLIC_KEY="${VITE_LANGFUSE_PUBLIC_KEY:-pk-lf-7482c23c-7f4a-498c-8642-cb60f94baea5}"
export VITE_LANGFUSE_BASE_URL="${VITE_LANGFUSE_BASE_URL:-https://fuse.beenex.cloud}"
