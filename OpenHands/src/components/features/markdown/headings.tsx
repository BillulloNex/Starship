...
export function h1({
  ...
  ExtraProps) {
  return (
    <h1 className="text-xl text-white font-semibold tracking-tight leading-7 mb-3 mt-5 first:mt-0">
      {children}
    </h1>
  );
}
...
export function h2({
  ...
  ExtraProps) {
  return (
    <h2 className="text-lg font-semibold tracking-tight text-white mb-2.5 mt-4 first:mt-0">
      {children}
    </h2>
  );
}
...
export function h3({
  ...
  ExtraProps) {
  return (
    <h3 className="text-base font-semibold tracking-tight text-white mb-2 mt-3.5 first:mt-0">
      {children}
    </h3>
  );
}
...
export function h4({
  ...
  ExtraProps) {
  return (
    <h4 className="text-sm font-semibold tracking-tight text-white mb-1.5 mt-3 first:mt-0">
      {children}
    </h4>
  );
}
