...
export const AGENT_SERVER_UI_DEFAULT_CSS_VARIABLES = {
  ...
  "--oh-color-logo": "#ffdb6e",
  "--oh-sticker-star": "#ffdb6e",
  "--oh-sticker-starship": "#a5e5a1",
  "--oh-sticker-automation": "#ff9368",
  "--oh-sticker-terminal": "#7893ff",
  "--oh-sticker-folder": "#b7a0ff",
  "--oh-sticker-hand": "#fa91ff",
  "--oh-sticker-agent": "#67e8f9",
  "--oh-color-base": "var(--cool-grey-950)",
  "--oh-color-base-secondary": "var(--cool-grey-925)",
  "--oh-color-danger": "#ff9368",
  "--oh-color-success": "#a5e5a1",
